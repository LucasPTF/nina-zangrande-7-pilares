      ...
      <section className="hero" id="inicio">
        <div className="shell hero__grid">
          <div className="hero__copy">
            <p className="eyebrow eyebrow--light">O MÉTODO PARA UMA BELEZA QUE LUCRA E TRANSFORMA</p>
            <h1>Você já domina a beleza.<span>Agora é hora de dominar o negócio.</span></h1>
            <p className="hero__lead">Construa uma empresa organizada, valorizada e preparada para crescer — sem continuar sustentando tudo apenas no seu esforço.</p>
            <div className="hero__actions">
              <a className="button button--gold" href="#inscricao">Quero entrar para os 7 Pilares</a>
